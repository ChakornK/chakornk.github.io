...
thumbnail: /projects/local-gems/1.png
...
![Gems list](/projects/local-gems/3.png)
![Gem view](/projects/local-gems/4.png)

It also has a built-in camera and photo editor UI so users can capture gems on the go and share them with others.

![Camera view](/projects/local-gems/5.png)
![Caption editor 1](/projects/local-gems/6.png)
![Caption editor 2](/projects/local-gems/7.png)
![Description editor](/projects/local-gems/8.png)
